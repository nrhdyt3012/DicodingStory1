...
class MainActivity : AppCompatActivity() {
    ...
    private fun observeStories() {
        viewModel.stories.observe(this, { pagingData ->
            Log.d("MainActivity", "Received paging data: ${pagingData}")
            storyAdapter.submitData( lifecycle,pagingData)  // Pastikan menggunakan storyAdapter yang sudah diinisialisasi
        })
    }
